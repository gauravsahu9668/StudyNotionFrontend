export const FooterLink2 = [
  ...
  },
  {
    ...
    links:[
      ...
      {title:"For students",link:"/paid-memberships"},
      {title:"Business Solutions",link:"/paid-memberships"}
    ]
  },
  {
    title:"Resourses",
    links:[
      {title:"Actions",link:"/paid-memberships"},
      {title:"Blog",link:"/paid-memberships"},
      {title:"Chart Sheet",link:"/paid-memberships"},
      {title:"Docs",link:"/paid-memberships"},
      {title:"Projects",link:"/paid-memberships"},
      {title:"Videos",link:"/paid-memberships"},
    ]
  }
];
